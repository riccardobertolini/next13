...
function InnerLayoutRouter({ parallelRouterKey , url , childNodes , childProp , segmentPath , tree , path , rootLayoutIncluded  }) {
    ...
    if (childProp && childProp.current !== null && !childNode) {
        childNodes.set(path, {
            data: null,
...
var _hooksClientContext = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/hooks-client-context.js (ecmascript, ssr)");
...
function Router({ initialHead , initialTree , initialCanonicalUrl , children , assetPrefix  }) {
    const initialState = (0, _react).useMemo(()=>{
        return {
            ...
            canonicalUrl: initialCanonicalUrl + (typeof window !== 'undefined' ? window.location.hash : '')
        };
    }, [
        children,
        initialCanonicalUrl,
...
class ErrorBoundaryHandler extends _react.default.Component {
    ...
    render() {
        if (this.state.error) {
            return _react.default.createElement(this.props.errorComponent, {
...
"[project-with-next]/node_modules/next/dist/client/components/hooks-client-context.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
function HotReload({ assetPrefix , children  }) {
    ...
    const handleOnUnhandledError = (0, _react).useCallback((ev)=>{
        if (ev.error && ev.error.digest && (ev.error.digest.startsWith('NEXT_REDIRECT') || ev.error.digest === 'NEXT_NOT_FOUND')) {
            ev.preventDefault();
            return;
        }
    ...
    const handleOnUnhandledRejection = (0, _react).useCallback((ev)=>{
        hadRuntimeError = true;
...
function tryApplyUpdates(onHotUpdateSuccess, sendMessage, dispatcher) {
    ...
    function handleApplyUpdates(err, updatedModules) {
        ...
        if (isUpdateAvailable()) {
            tryApplyUpdates(hasUpdates ? ()=>dispatcher.onBuildOk() : onHotUpdateSuccess, sendMessage, dispatcher);
        } else {
            dispatcher.onBuildOk();
...
var _storageJs = __turbopack_require__("[project-with-next]/node_modules/next/dist/client/components/static-generation-async-storage/storage.js (ecmascript, ssr)");
if ((typeof exports.default === 'function' || typeof exports.default === 'object' && exports.default !== null) && typeof exports.default.__esModule === 'undefined') {
    Object.defineProperty(exports.default, '__esModule', {
        value: true
    });
...
"[project-with-next]/node_modules/next/dist/client/components/static-generation-async-storage/storage.js (ecmascript, ssr)": (function({ r: __turbopack_require__, x: __turbopack_external_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, __dirname, m: module, e: exports }) { !function() {
...
if (process.env.NEXT_RUNTIME !== 'edge' && typeof window === 'undefined') {
    exports.staticGenerationAsyncStorage = staticGenerationAsyncStorage = new (__turbopack_external_require__('async_hooks')).AsyncLocalStorage();
}
if ((typeof exports.default === 'function' || typeof exports.default === 'object' && exports.default !== null) && typeof exports.default.__esModule === 'undefined') {
    Object.defineProperty(exports.default, '__esModule', {
        value: true
...
//# sourceMappingURL=node_modules_next_dist_client_components_layout-router.js.66bb1e265fffc61c.map